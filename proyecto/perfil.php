          ...
          if ($result = $connection->query($consulta)) {
              ...
              if ($result->num_rows===0) {
                ...
                while($f=$result->fetch_object()){
                   ...
                   echo '
                            <td>Usuario: <input type="text" name="usuario" value="'.$f->USER.'" > </td>
                        </tr>
                        <tr>
                            <td>Contraseña: <input type="text" name="passw" value='.$f->PASSW.' ></td>
                            <td>Nombre: <input type="text" name="nombre" value="'.$f->NOMBRE.'"> </td>
                        </tr>
                        <tr>
                            <td>Apellidos: <input type="text" name="apellidos" value="'.$f->APELLIDOS.'"></td>
                        </tr>
                        <tr>
                            <td>DNI: <input type="text" name="dni" value="'.$f->DNI.'"> </td>
                        </tr>
                    </table>
                    </fieldset>
                    <br>
...
if (isset($_POST["nombre"])) {
                        ...
                        $consulta="UPDATE USUARIO SET IDUSUARIO='".$id."',USER='".$usuario."', PASSW='".$passw."', NOMBRE='".$nombre."', APELLIDOS='".$apellidos."' ,DNI='".$dni."'";
