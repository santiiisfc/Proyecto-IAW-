  ...
  <div class="jumbotron" id="header">
    <div class="container text-center">
      ...
      <div class="alert alert-danger hidden" style="width:80%;margin: 0 auto;position:relative;top:-20px;height:60px;" role="alert">
        ...
        <strong id="alert_msg">¡¡Datos actualizados!!</strong>
      </div>
    </div>
  </div>
        ...
        if ($result = $connection->query($consulta)) {
          if ($result->num_rows===0) {
            ...
            while($f=$result->fetch_object()){
              ...
              <input type="text" name="use" value="'.$f->USERNAME.'" disabled> 
              </div>
              </div>
              </div>
              ...
              <input type="text" name="nom" value="'.$f->NOMBRE.'"> 
              </div>
              </div>
              </div>
              ...
              <input type="text" name="ape" value="'.$f->APELLIDOS.'"> 
              </div>
              </div>
              </div>
              ...
              <input type="text" name="cor" value="'.$f->CORREO.'"> 
              </div>
              </div>
              </div>';
