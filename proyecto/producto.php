...
<div class="container">
  <div class="col-md-12">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <input type="text" name="filtro" id="busqueda" placeholder="busqueda" size="40"></input>
      </div>
      <div class="col-md-3" style="margin-left:50px;" >
        <a class="btn btn-primary btn-sm" href="addpro.php" role="button">Añadir</a>
      </div>
    </div>

    <div class="row" id="tabla">
      <table class="table  col-md-12" style="margin:50px;" >
       <thead>
         <tr>
           <th>TIPO</th>
           <th>NOMBRE</th>
          ...
          if ($result->num_rows===0) {
            ...
            while($f=$result->fetch_object()){
             if($f->ESTADO == "no"){
               ...
               echo "<td>".$f->ESTADO."</td>";
               echo "<td><a class='btn btn-success' role='button' href='editproducto.php?id=$f->IDPRODUCTO'>Editar</a></td>";
               echo "</tr>";
